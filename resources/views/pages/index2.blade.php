                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                ...
                                <div class="service-title"><h5>Bases de Datos Cloud</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fas fa-globe"></i></div>
                                <div class="service-title"><h5>Hosting Web</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fas fa-file-code"></i></div>
                                <div class="service-title"><h5>Almacenamiento Cloud</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fas fa-chart-line"></i></div>
                                <div class="service-title"><h5>Analytics y Big Data</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fas fa-cloud-download-alt"></i></div>
                                <div class="service-title"><h5>Backup Automático</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fas fa-desktop"></i></div>
                                <div class="service-title"><h5>Escritorio Remoto</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fas fa-envelope"></i></div>
                                <div class="service-title"><h5>Servidores de Email</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fab fa-mixcloud"></i></div>
                                <div class="service-title"><h5>Cloud Híbrido</h5></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fas fa-desktop"></i></div>
                                <div class="service-title"><h5>Diseño Responsive</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fas fa-arrows-alt"></i></div>
                                <div class="service-title"><h5>Desarrollo React</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fab fa-android"></i></div>
                                <div class="service-title"><h5>Desarrollo Android</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fab fa-codepen"></i></div>
                                <div class="service-title"><h5>Desarrollo Web</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fas fa-sitemap"></i></div>
                                <div class="service-title"><h5>Arquitectura de Software</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fas fa-pencil-alt"></i></div>
                                <div class="service-title"><h5>Diseño UX/UI</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fas fa-project-diagram"></i></div>
                                <div class="service-title"><h5>Gestión de Proyectos</h5></div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="services-single-feature">
                                <div class="feature-icon"><i class="fas fa-mobile-alt"></i></div>
                                <div class="service-title"><h5>Aplicaciones Móviles</h5></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-counter">
                        <div class="counter-content">
                            <div class="counter-content-inner">
                                <div class="count-up-txt"><h1><span class="counter">15</span></h1></div>
                                <div class="counter-txt"><h3>K</h3></div>
                            </div>
                        </div>
                        <div class="counter-title"><h4>Clientes Satisfechos</h4></div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-3">
                    <div class="single-counter">
                        <div class="counter-content">
                            <div class="counter-content-inner">
                                <div class="count-up-txt"><h1><span class="counter">50</span></h1></div>
                                <div class="counter-txt"><h3>+</h3></div>
                            </div>
                        </div>
                        <div class="counter-title"><h4>Proyectos Completados</h4></div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-3">
                    <div class="single-counter">
                        <div class="counter-content">
                            <div class="counter-content-inner">
                                <div class="count-up-txt"><h1><span class="counter">24</span></h1></div>
                                <div class="counter-txt"><h3>/7</h3></div>
                            </div>
                        </div>
                        <div class="counter-title"><h4>Soporte Técnico</h4></div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-3">
                    <div class="single-counter">
                        <div class="counter-content">
                            <div class="counter-content-inner">
                                <div class="count-up-txt"><h1><span class="counter">100</span></h1></div>
                                <div class="counter-txt"><h3>%</h3></div>
                            </div>
                        </div>
                        <div class="counter-title"><h4>Satisfacción Garantizada</h4></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="team-single-member">
                        <div class="member-thumb">
                            ...
                            <div class="about-team-member">
                                <div class="member-name"><h4>Jhanmichael Garcia Campoverde</h4></div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3">
                    <div class="team-single-member">
                        <div class="member-thumb">
                            ...
                            <div class="about-team-member">
                                <div class="member-name"><h4>Equipo de Desarrollo</h4></div>
                                <div class="designation"><p>Desarrolladores</p></div>
                            </div>
                            <div class="member-social-link">
                                <ul>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3">
                    <div class="team-single-member">
                        <div class="member-thumb">
                            ...
                            <div class="about-team-member">
                                <div class="member-name"><h4>Equipo de Soporte</h4></div>
                                <div class="designation"><p>Soporte Técnico</p></div>
                            </div>
                            <div class="member-social-link">
                                <ul>
                                    <li><a href="mailto:informes@jotitasoft.com"><i class="far fa-envelope"></i></a></li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 grid-item prototype cemes">
                    <div class="portfolio-thumb">
                        ...
                        <div class="portfolio-content">
                            ...
                            <h5><a href="#">Digital Marketing Analysis</a></h5>
                            <p>Prototype</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 grid-item ux cemes">
                    <div class="portfolio-thumb">
                        ...
                        <div class="portfolio-content">
                            ...
                            <h5><a href="#">Awesome Creative Project</a></h5>
                            <p>UX Research</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 grid-item prototype web-design cemes">
                    <div class="portfolio-thumb">
                        ...
                        <div class="portfolio-content">
                            ...
                            <h5><a href="#">Business Solution</a></h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 grid-item prototype cemes">
                    <div class="portfolio-thumb">
                        ...
                        <div class="portfolio-content">
                            ...
                            <h5><a href="#">Apps Developments</a></h5>
                            <p>Prototype</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="pricing-single-item">
                        <div class="pricing-content">
                            <div class="section-title"><h4>Plan Básico</h4></div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="pricing-single-item style-two">
                        <div class="pricing-content">
                            <div class="section-title"><h4>Plan Avanzado</h4></div>
                            <div class="pricing-feature">
                                <ul>
                                    <li>30 días de prueba gratuita</li>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="pricing-single-item">
                        <div class="pricing-content">
                            <div class="section-title"><h4>Plan Empresarial</h4></div>
                            <div class="pricing-feature">
                                <ul>
                                    <li>30 días de prueba gratuita</li>
                ...
                <div class="testimonial-carousel owl-carousel">
                    <div class="testimonial-single-item">
                        <div class="testimonial-thumb">
                            ...
                            <div class="testimonial-icon"><span><i class="fas fa-quote-left"></i></span></div>
                        </div>
                ...
                <div class="blog-carousel owl-carousel">
                    <div class="blog-single-items">
                        <div class="blog-thumb">
                            <a href="#"><img src="{{ asset('cyber-it/assets/images/blog/blog-t1.jpg') }}" alt="thumb"></a>
                        </div>
                        <div class="blog-content">
                            ...
                            <div class="blog-page-title">
                                <h2><a href="#">Tiktok Illegally collecting data sharing</a></h2>
                            </div>
                            <p>Lorem ipsum dolor sit amet consectet adipisie cing elit sed eiusmod tempor incididunt on labore et dolore.</p>
                            <div class="blog-btn"><a href="#">Read More <i class="fa fa-angle-right"></i></a></div>
                        </div>
                    </div>
                    <div class="blog-single-items">
                        <div class="blog-thumb">
                            <a href="#"><img src="{{ asset('cyber-it/assets/images/blog/blog-t2.jpg') }}" alt="thumb"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="#">Jotitasoft</a>
                            ...
                            <div class="blog-page-title">
                                <h2><a href="#">How to learn PHP 10 tips to get you started</a></h2>
                            </div>
                            <p>Lorem ipsum dolor sit amet consectet adipisie cing elit sed eiusmod tempor incididunt on labore et dolore.</p>
                            <div class="blog-btn"><a href="#">Read More <i class="fa fa-angle-right"></i></a></div>
                        </div>
                    ...
                    <div class="blog-single-items">
                        <div class="blog-thumb">
                            <a href="#"><img src="{{ asset('cyber-it/assets/images/blog/blog-t3.jpg') }}" alt="thumb"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="#">Jotitasoft</a>
                            ...
                            <div class="blog-page-title">
                                <h2><a href="#">Convincing reasons you need to learn</a></h2>
                            </div>
                            <p>Lorem ipsum dolor sit amet consectet adipisie cing elit sed eiusmod tempor incididunt on labore et dolore.</p>
                            <div class="blog-btn"><a href="#">Read More <i class="fa fa-angle-right"></i></a></div>
                        </div>
                    ...
                    <div class="blog-single-items">
                        <div class="blog-thumb">
                            <a href="#"><img src="{{ asset('cyber-it/assets/images/blog/blog-t4.jpg') }}" alt="thumb"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="#">Jotitasoft</a>
                            ...
                            <div class="blog-page-title">
                                <h2><a href="#">The five devices you need to work anytime</a></h2>
                            </div>
                            <p>Lorem ipsum dolor sit amet consectet adipisie cing elit sed eiusmod tempor incididunt on labore et dolore.</p>
                            <div class="blog-btn"><a href="#">Read More <i class="fa fa-angle-right"></i></a></div>
                        </div>
